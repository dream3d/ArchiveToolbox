...
#ifndef _archivetoolboxplugin_h_
#define _archivetoolboxplugin_h_
...
/**
 * @brief The ArchiveToolboxPlugin class
 */
class ArchiveToolboxPlugin : public QObject, public ISIMPLibPlugin
{
    Q_OBJECT
    Q_INTERFACES(ISIMPLibPlugin)
    Q_PLUGIN_METADATA(IID "com.your.domain.ArchiveToolboxPlugin")

  public:
    ArchiveToolboxPlugin();
    virtual ~ArchiveToolboxPlugin();
  ...
  private:
    ...
    ArchiveToolboxPlugin(const ArchiveToolboxPlugin&); // Copy Constructor Not Implemented
    void operator=(const ArchiveToolboxPlugin&); // Operator '=' Not Implemented
};

#endif /* _ArchiveToolbox_H_ */
